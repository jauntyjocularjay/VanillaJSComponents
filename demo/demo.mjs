 ...
 * @todo Debug this
 */
h2.pushEventListener(onClickH2)
...
const options = [
    new OptionSelection('option1', 'Option 1'),
    new OptionSelection('option2', 'Option 2'),
    new OptionSelection('option3', 'Option 3'),
    new OptionSelection('option4', 'Option 4'),
    new OptionSelection('option5', 'Option 5'),
]
